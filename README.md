...
[Установка на Windows](INSTALL-WINDOWS.md) · [Установка на Linux](INSTALL-LINUX.md) · [Выбор варианта установки](INSTALL.md) · [Как проверяются требования](docs/NORMATIVE-CONTROL.md)
