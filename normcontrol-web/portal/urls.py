...
path('reports/',v.reports,name='reports'),path('settings/llm/',v.llm,name='llm'),path('settings/queue/',v.queue,name='queue'),path('settings/queue/<uuid:pk>/action/',v.queue_action,name='queue-action'),path('settings/users/',v.users,name='users'),path('settings/users/<int:pk>/toggle/',v.toggle_user,name='toggle-user'),path('settings/users/<int:pk>/password/',v.reset_user,name='reset-user'),path('settings/audit/',v.audit_log,name='audit'),path('account/password/',v.password,name='password'),path('health/',v.health)]
